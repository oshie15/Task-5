...
const books1 = generateBooks({ page: 1, limit: 3, seed: 'test123', region: 'en-US', avgLikes: 5, avgReviews: 2 });
...
const books2 = generateBooks({ page: 1, limit: 3, seed: 'test123', region: 'en-US', avgLikes: 10, avgReviews: 5 });
const books3 = generateBooks({ page: 1, limit: 3, seed: 'test123', region: 'en-US', avgLikes: 1, avgReviews: 0 });
...
const booksPage1 = generateBooks({ page: 1, limit: 2, seed: 'test123', region: 'en-US', avgLikes: 5, avgReviews: 2 });
const booksPage2 = generateBooks({ page: 2, limit: 2, seed: 'test123', region: 'en-US', avgLikes: 5, avgReviews: 2 });
